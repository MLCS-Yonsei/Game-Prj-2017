...
if __name__ == "__main__":
    train_x = np.load('/home/jehyunpark/data/train_x1500.npz')['a']
    ...
    train_y = np.load('/home/jehyunpark/data/train_y1500.npz')['a']
