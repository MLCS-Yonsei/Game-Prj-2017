...
if __name__ == "__main__":
    ...
    prediction, label, weights, biases = CNN(X, Y, config)
    ...
    with sess.as_default():
        ...
        for i in range(config.training_epochs):
            ...
            pred_out, accuracy_out, loss_out, weights_, biases_ = sess.run(
                [prediction, accuracy, cost, weights, biases], feed_dict={X: test_x, Y: test_y}
            )
