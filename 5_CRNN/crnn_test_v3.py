...
class Config(object):
  ...
  def __init__(self):
    # Input data
    W_h=np.load('./weights/weight_hidden1000.npy')
    W_o=np.load('./weights/weight_output1000.npy')
    B_h=np.load('./weights/biases_hidden1000.npy')
    B_o=np.load('./weights/biases_output1000.npy')
